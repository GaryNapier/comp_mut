...
vvvvv NEW NEW NEW NEW NEW NEW NEW NEW vvvv
...
fitness_pc_total_plot <- fitness_pc_total_plot + geom_text(data=subset(KRM_PRM_tab, change == "katG-p.Ser315Thr"),
                                                           ...
                                                           hjust = 1.1)
fitness_pc_total_plot <- fitness_pc_total_plot + coord_trans(x = 'log10')
...
KRM_PRM_CM_pc_tab <- cbind(status = KRM_PRM_CM_pc_tab$status, 
      ...
      resistance_level = as.character(KRM_PRM_CM_pc_tab$resistance_level),
