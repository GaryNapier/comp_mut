...
```{r binary-CM-KRM-PRM, echo = F, warning=F}
...
inh_CM_uniq <- unique(unlist(strsplit(inh_CM$CM, "; ")))
...
rif_CM_uniq <- unique(unlist(strsplit(rif_CM$CM, "; ")))
...
subset(inh_bin, !(is.na(CM)) & !(is.na(KRM)))
