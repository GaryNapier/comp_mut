...
rare_katg_table <- subset(isoniazid_binary_table, is.na(KRM) & !(is.na(CM)) & is.na(PRM) & !(is.na(other_katG)) )
...
rare_rpob_table <- subset(rifampicin_binary_table, is.na(KRM) & !(is.na(CM)) & is.na(PRM) & !(is.na(other_rpoB)) )
