...
The same approach was used to look for similar mutations that could confer RIF resistance. Using *rpoA* and *rpoC* as compensatory loci and *rpoB* as the resistance associated locus. In total, `r ifelse(rif_3_c == 0, "no", rif_3_c)` samples were found to have a CM but no known resistance mutation in *rpoB* (**Figure \@ref(fig:samples-trees)**).  
