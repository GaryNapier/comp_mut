...
<!-- CHECK! --> 
A Chi-square test showed a significant difference (`r fitness_x_sq`), with compensatory mutations occurring in a higher proportion in samples with PRMs (`r inh_4_e`/`r nrow(inh_PRM_no_katG_KRM)`) 
<!-- CHECK! --> 
