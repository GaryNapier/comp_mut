...
Number of samples, DST sensitive proportion, (predicted) DR type proportion and number of lineages for each isoniazid PRM:

`r knitr::kable(isoniazid_PRM_stats)`
