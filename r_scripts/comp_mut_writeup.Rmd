...
rm_null(lapply(PRM_tabs, function(x){
...
Using this approach reduced the number to `r inh_n_uniq_PRM_katg` unique mutations present in `r inh_4_e` samples which we term putative resistance mutations (Table 2). 
