...
Contrary to the results comparing the number of samples with compensatory mutations as a proxy of fitness cost, there was no significant difference in protein stability change between the 40 known resistance mutations and the `r MOST_IMPORTANT_NUMBER` putative resistance mutations (mean $\Delta\Delta$G: known `r fitness_t$estimate[1]` vs. putative `r fitness_t$estimate[2]`; Wilcoxon P = `r round(fitness_t$p.value, 2)`).
...
No significant differences were found in the proportion of isolates with (non-*katG*) known resistance mutation co-occurrence (our proxy for resistance level) between the 40 known resistance mutations and our `r MOST_IMPORTANT_NUMBER` putative resistance mutations. In showing a similar pattern of resistance mutation co-occurrence we infer that our putative resistance mutations confer a similar level of resistance as known mutations on average and that our putative resistance mutations are likely to be genuine. There was however a difference in the fitness cost between the 40 known and `r MOST_IMPORTANT_NUMBER` putative resistance mutations, with the latter appearing to have on average a higher cost. Whilst known resistance mutations are likely to converge on the most stable protein configurations and hence proliferate, the putative mutations are rarer and have not been associated with drug resistance before. There was no relationship between resistance level (using co-occurrence with other resistance mutations as a proxy) and fitness cost in either the 40 known or `r MOST_IMPORTANT_NUMBER` putative resistance mutations. Again, this similar pattern of variation indicates the veracity of the putative resistance mutations.
...
The 40 known resistance and other mutations co-occurring in isolates with the `r MOST_IMPORTANT_NUMBER` putative drug resistance mutations
...
Proportions of co-occurring known and compensatory resistance mutations for the 40 known and 31 putative *katG* resistance mutations. Mutations in fewer than three samples are omitted. Co-occurring known resistance mutations are in *fabG1*, *inhA*, and *kasA* genes.
...
Number of samples versus percentage of samples with a compensatory mutation for the 40 known and 31 putative katG mutations. Ser315Thr is labeled, and has low fitness cost, and infrequently co-occurs a compensatory mutation.
