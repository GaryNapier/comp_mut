...
<!-- CHECK! --> 
than those with Ser315Thr (`r inh_n_samps_ser315_and_CM`/`r fmt(nrow(inh_kat315_no_PRM))`), suggesting that on average they incur a greater fitness cost. 
<!-- CHECK! --> 
