...
inh_CM_tab$mutation <- paste0(drop_gene(inh_CM_tab$CM), " [", inh_CM_tab$n, "]")
...
rif_CM_tab <- sort_pos(pivot_num(subset(rif_CM_data, !is.na(CM)), formula(CM ~ 'n')), "CM")
rif_CM_tab$gene <- get_gene(rif_CM_tab$CM)


drop_gene(rif_CM_tab$CM)
...
rif_CM_tab$mutation <- paste0(, " [", rif_CM_tab$n, "]")
