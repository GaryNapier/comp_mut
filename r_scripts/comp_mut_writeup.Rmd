...
These successful mutations were then combined with the list of known compensatory mutations (KCM) to form a full list of compensatory mutations (CM).
...
Some variants were excluded from consideration for PRM. katG-Arg463Leu is known not to be associated with INH resistance [@Doorn2001]. katG-Val469Leu is lineage-specific to *M.orygis* [@Napier2020]. 
