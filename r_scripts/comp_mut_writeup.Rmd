...
# Lin
lin_pivot <- pivot(meta_table, formula(main_lineage ~ 'n' + Drug) )

# DR
drtype_pivot <- pivot(meta_table, formula(drtype ~ 'n' + Drug) )
...
KRM_pivot <- pivot(KRM_table, formula(KRM_binary ~ 'n' + Drug) )

# DST
dst_pivot <- pivot(meta_table, formula(dst ~ 'n' + Drug) )
...
names(table_1) <- c("Characteristic", "n isoniazid", "n rifampicin")
...
table_1 <- table_1[, c( "Category", "Characteristic", "n isoniazid", "n rifampicin")]
