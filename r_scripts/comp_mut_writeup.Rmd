...
# isoniazid_binary_table <- isoniazid_binary_table %>%
...
Comparison to Ser315Thr and Ser315Thr-fabG1 co-occurrence.
...
katg_fabg <- "katG-p.Ser315Thr; fabG1"
ser315thr_tab$KRM_2 <- ifelse(grepl("katG-p.Ser315Thr; fabG1", ser315thr_tab$KRM), "katG-p.Ser315Thr; fabG1", ser315thr_tab$KRM)
ser315thr_tab$KRM_2 <- ifelse(grepl("katG-p.Ser315Thr; katG", ser315thr_tab$KRM_2), "katG-p.Ser315Thr", ser315thr_tab$KRM_2)
ser315thr_tab$KRM_2 <- ifelse(grepl("; katG-p.Ser315Thr", ser315thr_tab$KRM_2), "katG-p.Ser315Thr", ser315thr_tab$KRM_2)
ser315thr_tab$KRM_2 <- ifelse(grepl("katG-p.Ser315Thr; inhA", ser315thr_tab$KRM_2), "katG-p.Ser315Thr; inhA", ser315thr_tab$KRM_2)
