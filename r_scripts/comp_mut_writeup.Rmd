...
That no RIF *rpoB* potential resistance mutations were found is unsurprising, since there are few ways in which the precise machinery of RNA polymerase can change without loss of function. In contrast, *katG* can change in many ways while the bacteria is largely unaffected. The 'rare' mutations could be considered potential resistance mutations with a larger sample size. hese mutations were discarded because they only appeared in one or two samples.
