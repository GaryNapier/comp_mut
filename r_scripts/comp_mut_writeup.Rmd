...
**Background:** Resistance to the first-line drugs isoniazid (INH) and rifampicin (RIF) in *Mycobacterium tuberculosis* (multidrug-resistant TB; MDR-TB) threatens disease control. In the development of *M. tuberculosis* resistance to anti-TB drugs, genetic mutations often come with a fitness cost. To overcome these fitness costs, *M. tuberculosis* can develop further, beneficial, compensatory mutations in genes that code for similar proteins. Here we leverage the presence of known and putative compensatory mutations along with phenotypic and genotypic data to detect the presence of novel mutations occurring in the target genes of INH (*katG*) and RIF (*rpoB*).

**Results:** Across XX isolates, there was XXX (XX%) with INH and XXX (XX%) with RIF phenotypic resistance. Known mutations in rpoB (n=XXX/XXX;) and katG (XXX/XXXX) explained most of the resistance. XXX known compensatory mutations were identified in XXX samples. By examining isolates with phenotypic resistance to INH or RIF, (predicted) genotypic resistance to other drugs and presence of compensatory mutations, we identified XXX novel resistance mutations where no known resistance ones were present.  XXX look at combinations for MDR XXXX

**Conclusions:** Detecting resistance mutations from whole genome sequencing can inform clinical management, but also revealed new variants linked to resistance. We have identified XXX new resistance markers, and after validation, added to a list of mutations for genotypic predictions.
