...
PCM_file=${local_metadata_dir}found_PCM.csv
...
# clean_PCM files
PCM_KCM_merged_file=${results_dir}${drug_of_interest}_PCM_KCM_merged.csv
...
echo " --- MERGING ${PCM_file} AND ${KCM_file} - RUNNING merge_PCM.R"
echo ""
